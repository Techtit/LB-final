      ...
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-sm font-sans mt-1">
            {isLogin ? "Sign in to sync your wishlist & checkout faster" : "Join Lalisa Belle for exclusive perks"}
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase"><span className="bg-background px-2 text-muted-foreground font-sans">or</span></div>
        </div>
